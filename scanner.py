...
این کد رو داشته باش ببین منطقش چجوری کار میکنه 
الان بردمش توی گیت هاب 
کد scanner.py 
رو این رو نوشتم درسته ؟؟؟
حس میکنم ی جاییش ایراد داره بر اساس کد داخل کولب ک کد اولی هست کد دومی دقیقا با همون منطق اوکی اش کن 
# scanner.py
# ⚠️ این کد دقیقاً همون کد گوگل کولب شماست، فقط با ۲ تغییر برای سازگاری با GitHub Actions
